        ...
        try:
            ...
            def enum_callback(hwnd, lparam):
                ...
                if length > 0:
                    ...
                    if any(kw in title_lower for kw in ["my_agent", "dashboard", "localhost", "3000", "edge", "chrome", "firefox"]) and "antigravity" not in title_lower and "code" not in title_lower:
